...
""" defines unit tests for mod/base_model.py."""
...
class TestBaseModelInstantiation(unittest.TestCase):
    """Testing instantiation off the BaseModel class."""
...
class TestBaseModelToDict(unittest.TestCase):
    """Testing the to_dict methood of the BaseModel class."""
...
class TestBaseModelSave(unittest.TestCase):
    """Testing the save methood of the BaseModel class."""
